    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/mall/multiphotoupload.action'; //upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/mall/photoupload.action',	//샘플 URL입니다.
 	        sCallback : '/mall/resources/smarteditor/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
