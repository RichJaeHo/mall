			...
			<div class="col span_3_of_3">
				<div class="contact-form">
					...
					<div>
						...
						<span><textarea id="form_content" rows="10" cols="100" style="width:100%; height:412px;"></textarea></span>
					</div>
					<div>
						<c:if test="${session != null}">
							<div>
								<input type="button" id="btnSendWriteNotice" class="myButton" value="보내기"> 
